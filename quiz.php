		...
		<form action="result.php" method="post" id="quiz">
            ...
            <ol>
                ...
                <li>
                    ...
                    <h3>What is "WWW"_____</h3>
                    
                    <div>
                        <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" />
                        <label for="question-1-answers-A">A) World wide web</label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="question-1-answers-C">C) Web Server</label>
                    </div>
                ...
                <li>
                    ...
                    <h3>Who Invented Java?</h3>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-A" value="A" />
                        <label for="question-2-answers-A">A) Shankunthala Devi</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-B" value="B" />
                        <label for="question-2-answers-B">B)  James A Gosling</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-C" value="C" />
                        <label for="question-2-answers-C">C) James T Russel</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-2-answers" id="question-2-answers-D" value="D" />
                        <label for="question-2-answers-D">D) Kristen Josepf</label>
                    </div>
                ...
                <li>
                    ...
                    <h3> 'Do no evil' is tag line of ......</h3>
